...
<span style="color:darkred">_Edit: 9/26_</span>
Added to Schedule resources for  

-   Derivatives ([To Deliver You From the Preliminary Terrors](https://calculusmadeeasy.org/1.html)
(Thank you Kate Eastman!)) 

-   The Chain Rule ([The Intuitive Notion of the Chain Rule](https://webspace.ship.edu/msrenault/geogebracalculus/derivative_intuitive_chain_rule.html))


<span style="color:darkred">_Edit: 11/12_</span>
Updated schedule due to members conference/symposium and holiday travel.
